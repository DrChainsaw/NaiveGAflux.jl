...
default_layerconf() = LayerVertexConf(ActivationContributionLow ∘ LazyMutable ∘ AutoOptimiser, NaiveGAflux.default_logging())
...
default_actfuns() = [identity, Flux.relu, Flux.elu, Flux.selu]
